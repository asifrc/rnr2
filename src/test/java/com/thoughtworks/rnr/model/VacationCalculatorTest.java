...
public class VacationCalculatorTest {
    ...
    private static final LocalDate ONE_WEEK_AFTER_SALESFORCE_START_DATE = Constants.START_DATE_JAN_1_2014.plusWeeks(1);
    private static final LocalDate FOUR_WEEKS_AFTER_SALESFORCE_START_DATE = Constants.START_DATE_JAN_1_2014.plusWeeks(4);
    private static final LocalDate TWO_WEEKS_AFTER_SALESFORCE_START_DATE = Constants.START_DATE_JAN_1_2014.plusWeeks(2);
    private static final LocalDate SIX_MONTHS_BEFORE_SALESFORCE_START_DATE = Constants.START_DATE_JAN_1_2014.minusMonths(6).minusDays(1);
    ...
    public void shouldCalculateVacationDaysAfterIntervalOfTime() {
        Employee employee = new Employee(Constants.START_DATE_JAN_1_2014, NO_ROLLOVER_DAYS, NO_TIME_OFF, NO_PERSONAL_DAYS_TAKEN, Constants.DEFAULT_ACCRUAL_RATE);
    ...
    public void shouldNotAccrueDaysPastVacationCap() {
        ...
        Employee employee = new Employee(Constants.START_DATE_JAN_1_2014, rolloverDays, NO_TIME_OFF, NO_PERSONAL_DAYS_TAKEN, Constants.DEFAULT_ACCRUAL_RATE);
    ...
    public void shouldDecrementVacationDaysFromTotal() {
        ...
        timeOff.put(Constants.START_DATE_JAN_1_2014, 40.0);
    ...
    public void shouldReturnZeroDaysIfEmployeeAtCap(){
        Employee employee = new Employee(Constants.START_DATE_JAN_1_2014, CAP_FOR_DEFAULT_ACCRUAL_RATE, NO_TIME_OFF, NO_PERSONAL_DAYS_TAKEN, Constants.DEFAULT_ACCRUAL_RATE);

        assertThat(vacationCalculator.getDaysUntilCapIsReached(employee, mockAccrualRateCalculator, Constants.START_DATE_JAN_1_2014), is(0.0));
    }
    ...
    public void shouldReturnNumberOfDaysBeforeCapIsReached(){
        ...
        assertThat(vacationCalculator.getDaysUntilCapIsReached(employee, mockAccrualRateCalculator, Constants.START_DATE_JAN_1_2014), is(twoWeeksInDays));
    }
