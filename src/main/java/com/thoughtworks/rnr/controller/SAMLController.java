...
public class SAMLController {
    ...
    public String handleOKTACallback(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            salesForceService.authenticateWithSalesForce(request, response); // comment this line for functional test run. ignore corresponding controller test.
            return null; // for real life, since this line of code never gets reached.
//            return "redirect:/home"; // for functional test run, since we need to comment out above.
        }
